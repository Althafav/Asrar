window.cfields = { "3": "country", "4": "nature_of_business", "6": "message", "296": "glass_show_interests", "298": "glass_show_book_your_stand", "299": "glass_show_download_brochure", "297": "glass_show_subscribe_to_newsletter", "328": "mainsource", "329": "subsource", "38": "forms_submitted" };
    ...
    script.onerror = function () {
        if (isSubmit) {
            if (script.src.length > 10000) {
                _show_error("436", "Sorry, your submission failed. Please shorten your responses and try again.");
            } else {
                _show_error("436", "Sorry, your submission failed. Please try again.");
            }
            submitButton.disabled = false;
            submitButton.classList.remove('processing');
        }
...
(function () {
    ...
    var _removed = false;
    var form_to_submit = document.getElementById('_form_436_');
    ...
    var form_submit = function (e) {
        ...
        if (validate_form()) {
            ...
            var serialized = _form_serialize(
                document.getElementById('_form_436_')
            ).replace(/%0A/g, '\\n');
            ...
            if ($("#field_299Yes").prop("checked") == true) {
                downloadDocument("Brochure.pdf", "/documents/IGS brochure 8.pdf");
            }

            

            /////Monday PUSH API Starts/////
            var interest = $('input[name="field[296][]"]:checked')
                .map(function () {
                    if ($(this).val() == "Media") {
            ...
            var itemName = name;
            var leadType = "IGS Lead";

            const mutation = `mutation {
          create_item(
              board_id: 7268050149, 
              group_id: \"new_group13419__1\", 
              item_name: \"${itemName}\", 
              column_values: \"{
