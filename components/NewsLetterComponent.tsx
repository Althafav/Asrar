                    ...
                    <div className="row g-5">
                        <div className="col-lg-6 ">
                            <div className="form-left">
                                ...
                                <p className="description mb-4">Stay informed! Subscribe to our newsletter for the latest updates and insights.</p>
                                <img src="/assets/imgs/glass-bg.jpg" alt="news-letter" className='d-lg-block d-none' />
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            <div className="form-right">
                                ...
                                <form method="POST" action="//ac.strategic.ae/proc.php" id="_form_436_" noValidate>
                                    ...
                                    <input type="hidden" name="or" value="573dfe6bd4b4aa0bbeac2fe3290dbd75" />
                                    <input type="hidden" name="field[38]" value="Glass Show - Newsletter" />
                                    <div className="_form-content row g-2">
                                        ...
                                        <div className="col-lg-6 ">
                                            <select name="field[3]" id="field[3]" className="form-control form-custom" required>
                                        ...
                                        <div className="col-12 d-none">
                                            ...
                                            <div className="_form_element _x92868921 _full_width " >
                                                <fieldset className="_form-fieldset">
                                                    ...
                                                    <div className="_row _checkbox-radio">
                                                        <input id="field_297Yes" type="checkbox" checked name="field[297][]" value="Yes" />
                                                        <span>
                                                            <label>
                                                                Yes
                                                            </label>
                                                    ...
                                                    <div className="_row _checkbox-radio">
                                                        <input id="field_297No" type="checkbox" name="field[297][]" value="No" />
                                                        <span>
                                                            <label>
                                                                No
                                                            </label>
                                        ...
                                        <div className="col-12 ">
                                            <div className="g-recaptcha mb-4" data-sitekey="6LcwIw8TAAAAACP1ysM08EhCgzd6q5JAOUR1a0Go">
                                            </div>

                                            <button type="submit" id="_form_436_submit" className="outline-cta">Subscribe</button>
                                        </div>
                                    </div>
