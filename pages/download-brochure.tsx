                    ...
                    <div className="row g-5 mt-5">
                        <div className="col-lg-5 d-lg-block d-none">
                            <div className="form-left">
                                <p className="section-heading">Download Brochure</p>
                            ...
                            <div className="form-right">
                                ...
                                <div className="">
                                    ...
                                    <form method="POST" action="//ac.strategic.ae/proc.php" id="_form_436_" noValidate>
                                        ...
                                        <input type="hidden" name="field[38]" value="Glass Show 2024 Download Brochure" />
                                        <div className="_form-content row g-2">
                                            ...
                                            <div className="col-lg-6 ">
                                                <div className="row g-2">
                                                    ...
                                                    <div className="col-8 col-md-8" style={{ position: 'relative' }}>
                                                        ...
                                                        <input type="number" id="phone" name="phone" className="form-control form-custom p-l-55" placeholder="Phone Number / رقم الهاتف" required style={{ paddingLeft: "60px" }} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 ">
                                            ...
                                            <div className="col-lg-6 ">
                                                <select name="field[4]" id="field[4]" className="form-control form-custom" required>
                                                    <option value="">Nature of Business * / طبيعة العمل </option>
                                            ...
                                            <div className="col-12 d-none">
                                                ...
                                                <div className="_form_element _x44366329 _full_width " >
                                                    <fieldset className="_form-fieldset">
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_299Yes" type="checkbox" checked name="field[299][]" value="Yes" />
                                                            <span>
                                                                <label>
                                                                    Yes
                                                                </label>
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_299No" type="checkbox" name="field[299][]" value="No" />
                                                            <span>
                                                                <label>
                                                                    No
                                                                </label>
