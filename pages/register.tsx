...
export default function RegisterPage() {
    useEffect(() => {
        if
            ...
            window.location.href = "https://register.strategic.ae/package/igs2024vis"
    ...
    return (
        <div className='margin_top d-none' >
            <Head>
                <title>{`${Globals.SITE_NAME} | Register`}</title>
                <meta
                    name="title"
                    content={`${Globals.SITE_NAME} | Register`}
                />
                <meta
                    name="description"
                    content={`${Globals.SITE_NAME} | Register your interest now.`}
                />
            </Head>
                    ...
                    <div className="row g-5 mt-5">
                        <div className="col-lg-6 ">
                            <div className="form-left">
                                <p className="section-heading ">Register your Interest</p>
                                <p className="description ">Want to stay updated? Fill out the form below to receive the latest news and updates about our event!</p>
