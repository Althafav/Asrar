...
export default class BookYourStand extends React.Component<
    {},
    {
...
> {
    ...
    componentDidMount() {
        ...
        const url = window.location.pathname.replace("/book-your-stand/", "");
        if (url.includes("[slug]")) {
            window.location.href = "/book-your-stand";
        }
        if (url) {
            if (url.includes("&")) {
                const urlArray = url.split('&');
                this.setState({
                    mainsource: urlArray[0],
                    subsource: urlArray[1],
                })
            }
            else {
                this.setState({
    ...
    render(): React.ReactNode {
        const { mainsource, subsource } = this.state;
        try {
        ...
        return (
            <React.Fragment>
                <Head>
                    ...
                    <meta
                        name="title"
                        content={`${Globals.SITE_NAME} | Book your stand`}
                    />
                    <meta
                        name="description"
                        content={`${Globals.SITE_NAME} | Ready to showcase your brand? Fill out the form below to secure your spot at our event!.`}
                    />
                </Head>
                            ...
                            <div className="row g-5 mt-5">
                                <div className="col-lg-6">
                                    ...
                                    <p className="description mb-3">Ready to showcase your brand? Fill out the form below to secure your spot at our event!</p>
                                        <img src="/assets/imgs/bookyourstand-bg.jpg" alt="" />
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-6">
                                    <div className="form-right">
                                        ...
                                        <form method="POST" action="https://strategic31677.activehosted.com/proc.php" id="_form_436_" className="_form _form_436 _inline-form  _dark" noValidate data-styles-version="4">
                                            ...
                                            <input type="hidden" name="field[38]" value="Glass Show 2024 Register Your Interest" />
                                            <input type="hidden" name="field[328]" value={mainsource} />
                                            <input type="hidden" name="field[329]" value={subsource} />
                                            <div className="_form-content row g-3">
