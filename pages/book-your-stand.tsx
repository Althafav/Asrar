...
export default function BookYourStand() {
    try {
    ...
    return (
        <div className=''>
            <Head>
                ...
                <meta name="description" content={`${Globals.SITE_NAME} | Ready to showcase your brand? Fill out the form below to secure your spot at our event!.`} />
            </Head>
                ...
                <div className="row g-5 mt-5">
                    <div className="col-lg-5 ">
                        <div className="form-left">
                            <div className="section-heading mb-3">Book Your Stand</div>
                            <p className="description mb-3">Ready to showcase your brand? Fill out the form below to secure your spot at our event!</p>
                            <img src="/assets/imgs/cosmetics.jpg" alt="bookyourstand" className='d-lg-block d-none' />
                        </div>
                    </div>
                    ...
                    <div className="col-lg-7">
                        <div className={`form-right `}>
                            ...
                            <form method="POST" action="https://strategic31677.activehosted.com/proc.php" id="_form_436_" className="_form _form_436 _inline-form  _dark" noValidate data-styles-version="4" style={{ direction: "ltr" }}>
                                ...
                                <input type="hidden" name="field[38]" value="Glass Show 2024 Book your Stand" />
                                <div className="_form-content row g-2">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="row g-2">
                                            ...
                                            <div className="col-8 col-md-8 " style={{ position: "relative" }}>
                                                ...
                                                <input type="number" id="phone" name="phone" className="form-control form-custom " placeholder="Phone / رقم الهاتف" required style={{ paddingLeft: "60px" }} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 ">
                                    ...
                                    <div className="col-md-12 " hidden>
                                        <textarea id="field[6]" name="field[6]" className="form-control form-custom" aria-label="With textarea" placeholder="Message / رسالة" ></textarea>
                                    </div>
                                        ...
                                        <div className="_form_element _x89857204 _full_width " >
                                            <fieldset className="_form-fieldset">
                                                ...
                                                <div className="_row _checkbox-radio">
                                                    <input id="field_296Exhibitor" type="checkbox" name="field[296][]" className="any" checked disabled required value="Exhibitor" />
                                    ...
                                    <div className="col-12 d-none">
                                        <div className="_form_element _x47798909 _full_width " >
                                            <fieldset className="_form-fieldset">
                                                ...
                                                <div className="_row _checkbox-radio">
                                                    <input id="field_298Yes" type="checkbox" checked name="field[298][]" value="Yes" />
                                                    <span>
                                                        <label>
                                                            Yes
                                                        </label>
                                                ...
                                                <div className="_row _checkbox-radio">
                                                    <input id="field_298No" type="checkbox" name="field[298][]" value="No" />
                                                    <span>
                                                        <label>
                                                            No
                                                        </label>
                                    ...
                                    <div className="col-12 text-start">
                                        ...
                                        <button type="submit" id="_form_436_submit" className=" btn-submit--contact-us" >Submit</button>
                                    </div>
                                </div>
